...
DEFAULT_PARAMS.set('forward_step', 0.35, 0.12, 0.37)
DEFAULT_PARAMS.set('forward_drift', 0, -0.05, 0.05)
DEFAULT_PARAMS.set('turn_step', 20, 10, 30)
DEFAULT_PARAMS.set('bot_radius', 0.4, 0.38, 0.42)
DEFAULT_PARAMS.set('cam_pitch', -20, -100, 5)
DEFAULT_PARAMS.set('cam_fov_y', 60, 55, 65)
DEFAULT_PARAMS.set('cam_height', 2.0, 1.45, 2.55) #0.45-0.5
